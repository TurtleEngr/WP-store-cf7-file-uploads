...
function nmr_normalize_file_name($file_name)
{
...
function nmr_unique_file_name($file_path)
{
...
function nmr_create_attachment($filename)
{
    ...
    $attachFileName = $wp_upload_dir['path'] . '/' . nmr_normalize_file_name(basename($filename));
    $attachFileName = apply_filters('nmr_create_attachment_file_name', $attachFileName);
    $attachFileName = nmr_unique_file_name($attachFileName);
